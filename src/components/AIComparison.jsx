...
const AIComparison = () => {
  ...
  return (
    <section className="py-20 bg-[#F7F7F9] overflow-hidden">
      <div className="wrapper relative">
        ...
        <div data-aos="fade-up" className="mt-16 relative z-10">
          <h3 className="section-heading mb-6 text-center">
          ...
          <div className="bg-white rounded-xl border border-gray-100 shadow-md overflow-hidden">
            ...
            <div className="divide-y divide-gray-100">
              ...
              <div className="grid grid-cols-3 hover:bg-gray-50 transition-colors">
                <div className="p-4 font-medium text-gray-800 flex items-center">Autonomy</div>
                <div className="p-4 text-center text-gray-600 flex items-center justify-center">
                  <span className="text-sm sm:text-base">Limited to programmed tasks</span>
                </div>
                <div className="p-4 text-center text-gray-600 flex items-center justify-center">
                  <span className="text-sm sm:text-base">High level of independent operation</span>
                </div>
              </div>
              
              {/* Learning Capability */}
              <div className="grid grid-cols-3 hover:bg-gray-50 transition-colors">
                <div className="p-4 font-medium text-gray-800 flex items-center">Learning Capability</div>
                <div className="p-4 text-center text-gray-600 flex items-center justify-center">
                  <span className="text-sm sm:text-base">Specific to designated domain</span>
                </div>
                <div className="p-4 text-center text-gray-600 flex items-center justify-center">
                  <span className="text-sm sm:text-base">Continuous learning across domains</span>
                </div>
              </div>
              
              {/* Decision Making */}
              <div className="grid grid-cols-3 hover:bg-gray-50 transition-colors">
                <div className="p-4 font-medium text-gray-800 flex items-center">Decision Making</div>
                <div className="p-4 text-center text-gray-600 flex items-center justify-center">
                  <span className="text-sm sm:text-base">Rule-based or model-based</span>
                </div>
                <div className="p-4 text-center text-gray-600 flex items-center justify-center">
                  <span className="text-sm sm:text-base">Complex reasoning with multiple factors</span>
                </div>
              </div>
              
              {/* Adaptability */}
              <div className="grid grid-cols-3 hover:bg-gray-50 transition-colors">
                <div className="p-4 font-medium text-gray-800 flex items-center">Adaptability</div>
                <div className="p-4 text-center text-gray-600 flex items-center justify-center">
                  <span className="text-sm sm:text-base">Limited by initial programming</span>
                </div>
                <div className="p-4 text-center text-gray-600 flex items-center justify-center">
                  <span className="text-sm sm:text-base">Highly adaptable to new situations</span>
                </div>
              </div>
              
              {/* System Integration */}
              <div className="grid grid-cols-3 hover:bg-gray-50 transition-colors">
                <div className="p-4 font-medium text-gray-800 flex items-center">System Integration</div>
                <div className="p-4 text-center text-gray-600 flex items-center justify-center">
                  <span className="text-sm sm:text-base">Usually operates in isolation</span>
                </div>
                <div className="p-4 text-center text-gray-600 flex items-center justify-center">
                  <span className="text-sm sm:text-base">Orchestrates multiple systems and agents</span>
                </div>
              </div>
            </div>
          </div>
          
          {/* Mobile-only comparison cards - shown only on very small screens */}
          <div className="sm:hidden mt-8 space-y-4">
            <div className="text-center text-sm text-gray-500 mb-4">Swipe horizontally to view full comparison →</div>
          </div>
        </div>

        {/* Call to Action */}
        <div data-aos="fade-up" className="mt-16 text-center relative z-10">
          <h3 className="section-heading mb-4 text-gray-800">Ready to Explore Advanced AI Solutions?</h3>
